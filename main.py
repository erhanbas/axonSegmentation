...
if __name__ == '__main__':
    ...
    experiment_folder = os.path.join(data_folder, 'JW', 'test')
    number_of_level = 3
    ...
    with h5py.File(cropped_h5_file, "r") as f:
        ...
        for ix, txt in enumerate(recon[:, :]):
            ...
            radius_estimate_around_trace = gaussian_filter1d(radius_estimate_around_trace,2)
        ...
        if create_JW_workspace:
            ...
            converter = func.Convert2JW(cropped_h5_file,experiment_folder,number_of_level=number_of_level)
